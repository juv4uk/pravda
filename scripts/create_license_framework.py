...
content = """# КОНЦЕПТУАЛЬНИЙ ФРЕЙМВОРК ЛІЦЕНЗІЇ ПРАВ І ВОЛЬНОСТЕЙ (VOLNOST-BASED LICENSE FRAMEWORK)
...
with open("/home/agents/GitHub/pravda/license/VOLNOST-LICENSE-FRAMEWORK.md", "w", encoding="utf-8") as f:
    f.write(content)

print("Created /home/agents/GitHub/pravda/license/VOLNOST-LICENSE-FRAMEWORK.md successfully!")
