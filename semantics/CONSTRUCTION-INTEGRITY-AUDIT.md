...
> 5. **FOUR-TIER GLOSS SPECIFICATION (ANTI-LEAKAGE PROTOCOL)**:
>    - `FORMAL SYNTACTIC FRAME`: точний структурний шаблон сполучуваності.
>    - `SOURCE-NEAR GLOSS`: буквальне значення, максимально близьке до тексту епохи (без сучасного юридичного перекладу).
>    - `CONTEXTUAL RECONSTRUCTION`: історико-правова функція в системі конкретного пам'ятника.
>    - `MODERN ANALOGY (CAUTIONARY)`: евристична сучасна паралель (строго маркується: MODERN ANALOGY ≠ HISTORICAL SENSE).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **3**
  - **`SENTENCE-COUNT`:** **3**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «як домовлявся / як укладав ряд перед свідками».
  - **CONTEXTUAL RECONSTRUCTION:** Усне погодження індивідуальних умов боргу, відсотків чи шлюбу, дійсність якого підтверджується свідками-послухами.
  - **MODERN ANALOGY (CAUTIONARY):** Усний цивільний договір (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **3**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «без розпорядження / без домовленості» або «із домовленістю / за рядом».
  - **CONTEXTUAL RECONSTRUCTION:** Кваліфікація статусу: наявність ряду рятує від холопства або визначає порядок розподілу майна після смерті; відсутність ряду вмикає законний спадковий чи становий дефолт.
  - **MODERN ANALOGY (CAUTIONARY):** Спадкування за заповітом / без заповіту; договірне застереження статусу (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **1**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «такий є встановлений звичай / такий є порядок».
  - **CONTEXTUAL RECONSTRUCTION:** Констатація законного правила: визначення прав вітчима та дітей щодо спадщини матері за звичаєвим порядком.
  - **MODERN ANALOGY (CAUTIONARY):** Презумпція законного правопорядку (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **3**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «відкритим порядком та ходом права».
  - **CONTEXTUAL RECONSTRUCTION:** Офіційна судова процедура за Статутом: розгляд справи у відкритому судовому засіданні за участі сторін (повода і винуватого) без таємного свавілля.
  - **MODERN ANALOGY (CAUTIONARY):** Належна правова процедура / due process of law (*MODERN ANALOGY ≠ HISTORICAL SENSE; термін due process заборонено як прямий переклад*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «у нашій Раді / в урядових колегіях і судах».
  - **CONTEXTUAL RECONSTRUCTION:** Позначення вищого владного кола монарха (Пани-Рада ВКЛ) та загальної структури судових і адміністративних лав.
  - **MODERN ANALOGY (CAUTIONARY):** Державний апарат / урядовий кабінет (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **6**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «домовленості та встановлені постанови».
  - **CONTEXTUAL RECONSTRUCTION:** Заголовкова парна формула для позначення збірника погоджених пунктів між новообраним гетьманом та Військом Запорозьким.
  - **MODERN ANALOGY (CAUTIONARY):** Конституційний договір / основний закон (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «узгодили в переговорах і постановили ухвалу».
  - **CONTEXTUAL RECONSTRUCTION:** Перформативна словесна формула взаємного погодження умов між двома суб'єктами: генеральною старшиною/військом та гетьманом.
  - **MODERN ANALOGY (CAUTIONARY):** Двосторонній суспільний контракт (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **5**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «непорушно додержувати присягнутих домовленостей / віддати виконанню».
  - **CONTEXTUAL RECONSTRUCTION:** Об'єктне вживання: підтверджені присягою статті розглядаються як непорушний закон, відхилення від якого є порушенням присяги.
  - **MODERN ANALOGY (CAUTIONARY):** Обов'язковість виконання договору (pacta sunt servanda) (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «відповідно до Зборівської угоди / за посольськими статтями».
  - **CONTEXTUAL RECONSTRUCTION:** Посилання на раніше укладений та скріплений акт як джерело обов'язку протилежної сторони.
  - **MODERN ANALOGY (CAUTIONARY):** Чинний міжнародний договір (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «загальною домовленістю встановлюється і узаконюється».
  - **CONTEXTUAL RECONSTRUCTION:** Ухвалення фіскально-адміністративного порядку спільною згодою старшини й гетьмана, а не одноосібним універсалом.
  - **MODERN ANALOGY (CAUTIONARY):** Парламентський / суспільний консенсус (*MODERN ANALOGY ≠ HISTORICAL SENSE; слово consensus заборонено як прямий глос*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **5**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «пакти (договірні статті) Гадяцькі / пакти і постанови».
  - **CONTEXTUAL RECONSTRUCTION:** Латинсько-польська титульна назва письмового артикульованого акта високого рівня (унія, замирення, обрання володаря).
  - **MODERN ANALOGY (CAUTIONARY):** Міжнародно-правовий трактат / союзний пакт (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **4**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «для укладення / кращого утвердження цих пактів».
  - **CONTEXTUAL RECONSTRUCTION:** Дипломатична та сеймова процедура скріплення артикулів присягою уповноважених осіб і ратифікацією королем і сеймом.
  - **MODERN ANALOGY (CAUTIONARY):** Ратифікація міждержавного договору (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FOUR-TIER SEMANTIC SPECIFICATION):**
  - **SOURCE-NEAR GLOSS:** «пактами (договорами) обваровані (укріплені) та стверджені кордони».
  - **CONTEXTUAL RECONSTRUCTION:** Вказівка на юридичну захищеність рубежів Вітчизни міжнародними угодами, укладеними з сусідніми монархіями (Польщею, Кримом/Портою, Московією).
  - **MODERN ANALOGY (CAUTIONARY):** Міжнародно визнані кордони / територіальна цілісність (*MODERN ANALOGY ≠ HISTORICAL SENSE*).
