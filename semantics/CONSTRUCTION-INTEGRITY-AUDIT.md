...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **3**
  - **`SENTENCE-COUNT`:** **3**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Взаємне усне узгодження індивідуальних умов перед свідками. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Формування договірного зобов'язання у додержавному звичаєвому праві без писаного акта. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **3**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Юридична кваліфікація правочину залежно від наявності чи відсутності договору/заповіту. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Запобігання переходу вільної людини в холопство або регулювання спадкування за звичаєм у разі відсутності волевиявлення. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **1**
  - **`SENTENCE-COUNT`:** **1**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Нормативне встановлення, правомірний порядок спадкування. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Формулювання імперативної норми у формі констатації чинного правопорядку. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **3**
  - **`SENTENCE-COUNT`:** **3**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Гласний, відкритий і належний судовий процес (due process of law). `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Процесуальна гарантія шляхетського імунітету від свавільного покарання без вироку відкритого суду. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **2**
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Державна рада, вища урядова колегія Великого Князівства Литовського. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Інституціоналізація терміна *ряд* як синоніма урядової колегії та посадового апарату. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **6**
  - **`SENTENCE-COUNT`:** **6**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Офіційна назва установчого акта двостороннього погодження прав і повноважень. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Рецепція дипломатичної формули козацької республіки для закріплення виборчих капітуляцій обраного гетьмана. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **2**
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Двосторонній акт укладення взаємних зобов'язань між виборцями і обраним правителем. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Перформативна мовна дія, що конституює владу гетьмана як обмежену угодою з військом. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`SENTENCE-COUNT`:** **5**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Сукупність затверджених зобов'язань як обов'язкова правова норма для сторін. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Забезпечення юридичної сили пактів через підпорядкування їм дій гетьмана та гарантію шведського протектора. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **3**
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Правовий прецедент або діюча міжнародна угода як джерело легітимності вимог. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Дипломатична аргументація в міждержавних переговорах через посилання на договірне право. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **2**
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Спосіб конституювання правової норми через спільну згоду корпорації станів. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Запровадження принципу суспільного консенсусу («общий договор») як джерела закону в козацькій державі. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **5**
  - **`SENTENCE-COUNT`:** **5**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Назва міждержавного публічно-правового трактату або конституційного скріплення унії. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Рецепція поняття *pacta* з польського публічного права (pacta conventa) для позначення засад державного співжиття. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **4**
  - **`SENTENCE-COUNT`:** **4**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Акт міждержавного ратифікування та скріплення присягою міжнародного договору. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Надання публічно-правовому пакту остаточної непорушної сили через сеймову ратифікацію та сенаторську/гетьманську присягу. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
...
- **МЕТРИКА ВХОДЖЕНЬ (THREE-TIER METRICS):**
  ...
  - **`CONSTRUCTION-INSTANCE-COUNT`:** **4**
  - **`SENTENCE-COUNT`:** **2**
- **СЕМАНТИЧНИЙ ГЛОС-КАНДИДАТ (GLOSS CANDIDATE):** Міжнародно-правове договірне закріплення та непорушність кордонів держави. `[PROVISIONAL]`
- **ФУНКЦІОНАЛЬНА ГІПОТЕЗА (FUNCTION HYPOTHESIS):** Використання багатосторонніх пактів як інструменту легітимації суверенної території перед сусідніми державами. `[PROVISIONAL]`
- **ПОВНИЙ ПЕРЕЛІК ЗАСВІДЧЕНИХ ІНСТАНЦІЙ (LOCATOR-LEVEL LEDGER WITH MATCH-EVIDENCE):**
