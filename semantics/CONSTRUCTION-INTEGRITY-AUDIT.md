...
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FIVE-TIER EPISTEMIC PIPELINE):**
  ...
  - **LEXICOGRAPHIC GLOSS (L2 EVIDENCE):** `[LEX-EVID-029]`, `[LEX-EVID-030]`: СЛМ XVI–XVII (Вип. 21, с. 14): «пактъ (частіше pl. пакты) — артикули публічної згоди, мирний трактат, умови договору»; Brückner (s. 392): «pakt, pakta — публічно-правові артикули угоди, запозичення з латини (pactum / pacta conventa)».
...
- **СЕМАНТИЧНЕ РОЗШАРУВАННЯ (FIVE-TIER EPISTEMIC PIPELINE):**
  ...
  - **LEXICOGRAPHIC GLOSS (L2 EVIDENCE):** `[LEX-EVID-029]`, `[LEX-EVID-030]`: СЛМ XVI–XVII (Вип. 21, с. 14): «заключити / утвердити пакты — надати чинності домовленостям через формальний публічний акт»; Brückner (s. 392): «zawrzeć pakta — скласти формальну присяжну угоду».
