...
- `CONTEMPORARY-LEGAL-PARALLEL` / `HISTORICAL-PARALLEL` — зовнішній контекст, що свідчить про схожість ідеї або генезу правових інститутів.
- `OWNER-DECISION-REF` — пряме суверенне рішення власника екосистеми (до його наявності: `NONE`, статус: `PROPOSED`).
- **Сувора заборона ретроспективної проєкції (Anti-Teleological Proscription)**: Заборонено видавати історичні станові привілеї ранньомодерної доби за «давньоукраїнські коріння загальних прав людини».

### 0.4. Висновки Reverse Provenance Search: Історичні «Вольності» vs Авторські «Вольності»
На основі наскрізного ретроспективного дослідження джерел (Бендери 1710 ➔ Гетьманські статті ➔ Гадяч 1658 ➔ Генрихові артикули 1573 ➔ Литовські Статути 1566/1588 ➔ Руська Правда XI–XII ст.; див. `pravda/research/RIGHTS-LIBERTIES-AND-BOUND-POWER.md`):

1. **Історичні «Права і вольності» — це корпоративністанові імунітети (`libertates`), а не абстрактні права людини**:
   - Носіями «вольностей» в історичних пам'ятках виступають виключно корпоративні суб'єкти: шляхта/лицарство (Статути ВКЛ), козацьке Військо Запорозьке (Зборів, Березневі, Гадяч, 1710) або самоврядні міські міщанські громади (магдебургія).
   - Для некорпоративного посполитого населення (селянство, піддані, челядь) історичні договори не встановлювали «вольностей», а лише фіксували обсяг підданства, захист від незаконних поборів (стаття 14, 16 Орлика 1710) або судову процедуру.
2. **Універсальність захисту в HFL / VEPL — це суверенне аксіоматичне рішення (`OWNER-DECISION-REF`), а не історичний факт**:
   - Положення про невідчужувану гідність і захист *кожної особи* в системі `pravda` є **свідомим аксіоматичним розривом зі становим егоїзмом минулого**, а не «продовженням традиції 1649/1710 років».
   - Історичний матеріал надає архітектурні прецеденти **зв'язаної влади (bound power), процедури суду та пакту**, але моральний периметр їх застосування встановлюється автором екосистеми на основі етичного вибору, а не ретроспективної ілюзії.
...
- **BRIDGE-PREMISE**: EXPLICIT: Універсальна гідність і захист особи є авторським ціннісним вибором (`OWNER-DECISION-REF`), а не деривативом ранньомодерного станового права; історичні «права і вольності» надають техніку зв'язаної влади (процедуру суду, заборону свавілля), але обмежувалися корпораціями (шляхта, Військо Запорозьке). Екосистема pravda свідомо універсалізує цей захист як власну конституційну основу.
- **CONTRARY-EVIDENCE**: Утилітаризм (Пітер Сінгер: моральний статус пропорційний здатності відчувати біль/інтереси, виключаючи ембріони/коматозників); феодальне станове право (кріпацтво для нереєстрових селян у Зборові 1649; феодальна залежність у Статутах ВКЛ 1566/1588).
- **DECISION-AUTHORITY**: `OWNER`.
- **EVIDENTIARY-STATUS**: `PLAUSIBLE` (як аксіоматична пропозиція; очікує на пряме суверенне рішення `OWNER-DECISION-REF`).
- **DOES-NOT-IMPLY**:
  - Що універсальні права людини вже існували в документах 1649 чи 1710 років (історичні документи знали лише станові корпоративні вольності `libertates`);
...
- **SOURCE-REF**: Конституція Пилипа Орлика; Березневі статті 1654; Статут ВКЛ 1588; Руська Правда; Hohfeld, W.N., "Some Fundamental Legal Conceptions as Applied in Judicial Reasoning".
- **SOURCE-LOCATOR**: Орлик 1710 (преамбула, ст. 6); Березневі статті 1654 ст. 1–3; СВКЛ 1588 розд. 1, арт. 1, 2; РП Поширена ст. 57 (Устав Володимира Мономаха); HISTORICAL-SYNTHESIS.md (Аксіоми 2, 4); Yale Law Journal, 1913, 23(1): 16–59.
- **SOURCE-CLAIM**: Хохфельд суворо розділяє «Права-Вимоги» (Rights/Claims) від «Повноважень» (Powers). Конституція 1710 фіксує: влада гетьмана обмежена Генеральною Радою («не так хочу, так повелеваю»), а права і вольності Війська є непорушним бар'єром проти самовладдя. СВКЛ 1588: господар обмежений писаним правом і не може карати «на заочное поведанье». Руська Правда: князь обмежений об'єктивним тарифом вір і судовою процедурою (закуп має право скаржитися на пана).
- **DIRECTNESS**: `INFERRED`.
- **BRIDGE-PREMISE**: EXPLICIT: У системі pravda термін «вольності» зарезервований для захисту від влади, тому інституційна влада не може бути наділена вольностями проти тих, кого вона регулює; інституції володіють виключно повноваженнями (`potestas / powers`), які зв'язані правом і процедурою (`bound power`).
...
- **EVIDENTIARY-STATUS**: `CONTESTED` (У США корпорації мають права людини; в континентальній та русько-литовській традиції це інституційні повноваження).
- **DOES-NOT-IMPLY**:
  - Що інституції чи корпорації позбавлені легітимної влади або права на цивільний захист своєї власності чи контрактів у суді;
  - Що гетьмани чи князі в історії не намагалися де-факто узурпувати владу (саме проти цього узурпаторського свавілля правові документи й вибудовували формальні бар'єри).
...
- **DOES-NOT-IMPLY**:
  ...
  - Що відмова від приватної самовільної блокади ШІ є послабленням безпеки (навпаки: згідно з традицією Руської Правди та Литовських Статутів, жодна кара чи обмеження не можуть чинитися «на заочное поведанье» чи за суб'єктивним розсудом виконавця, а лише за формалізованою, аудитованою процедурою суду/верифікатора).
